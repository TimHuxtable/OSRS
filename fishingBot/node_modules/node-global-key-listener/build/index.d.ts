import { IConfig } from "node-global-key-listener/build/ts/_types/IConfig";
import { IGlobalKeyListener } from "node-global-key-listener/build/ts/_types/IGlobalKeyListener";
import { IGlobalKeyServer } from "node-global-key-listener/build/ts/_types/IGlobalKeyServer";
export * from "node-global-key-listener/build/ts/_types/IGlobalKeyListener";
export * from "node-global-key-listener/build/ts/_types/IGlobalKeyEvent";
export * from "node-global-key-listener/build/ts/_types/IGlobalKey";
export * from "node-global-key-listener/build/ts/_types/IGlobalKeyDownMap";
export * from "node-global-key-listener/build/ts/_types/IWindowsConfig";
export * from "node-global-key-listener/build/ts/_types/IConfig";
/**
