...
var rc = require('prebuild-install/rc')(pkg)
var log = require('prebuild-install/log')(rc, process.env)
var download = require('prebuild-install/download')
var asset = require('prebuild-install/asset')
var util = require('prebuild-install/util')

var prebuildClientVersion = require('prebuild-install/package.json').version
if (rc.version) {
